  ...
  const userRows = filteredUsers.slice(startIndex, endIndex).map((flight) => {
    return (
      <TableRow key={flight.callsign} >
        ...
        <TableCell sx={{ border: '1px solid  #4f3f84', color:'#FF662A' }}>{flight.estArrivalAirport}</TableCell>
        <TableCell sx={{ border: '1px solid  #4f3f84', color:'#FF662A' }}>{new Date(flight.firstSeen * 1000).toLocaleString()}</TableCell>
        <TableCell sx={{ border: '1px solid  #4f3f84', color:'#FF662A' }}>{flight.estArrivalAirportHorizDistance}</TableCell>
        <TableCell sx={{ border: '1px solid  #4f3f84', color:'#FF662A' }}>{flight.arrivalAirportCandidatesCount}</TableCell>
        <TableCell sx={{ border: '1px solid  #4f3f84', color:'#FF662A' }}>{flight.estArrivalAirportVertDistance}</TableCell>
      </TableRow>
    );
  });
...
<Table>
  <TableHead>
    <TableRow>
      ...
      <TableCell sx={{ border: '1px solid  #4f3f84', color:'#FF662A' }}>Arrival Airport</TableCell>
      <TableCell sx={{ border: '1px solid  #4f3f84', color:'#FF662A' }}>First Seen</TableCell>
      <TableCell sx={{ border: '1px solid  #4f3f84', color:'#FF662A' }}>Arrival Airport Horiz Distance</TableCell>
      <TableCell sx={{ border: '1px solid  #4f3f84', color:'#FF662A' }}>Arrival Airport Candidates Count</TableCell>
      <TableCell sx={{ border: '1px solid  #4f3f84', color:'#FF662A' }}>Arrival Airport Vert Distance</TableCell>
    </TableRow>
  </TableHead>
